    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <h4>Connectez-vous pour publier votre offre !</h4>
          <div class="d-flex justify-content-center align-items-center h-100">
          <p>Vous avez déjà un compte ? <a href="{{ route('login-p') }}">Connexion</a></p>
</div>
      </div>
        </div>

        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-center justify-content-center" id="form-p">
            <form action="{{ route('register-p') }}"method="post" role="form" class="php-email-form">
            @csrf
              <div class="row">
              ...
              <div class="my-3">
                ...
                <div class="sent-message"> Vous avez connecté avec succès</div>
              </div>
